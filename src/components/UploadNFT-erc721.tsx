...
export default function UploadNFT({
  ...
  async function createCollection() {
    try {
      ...
      await transaction.wait();
      handleClick(`Your Collection is created and the NFT is getting minted. Please wait for sometime before you try to view it!`, 'success');
    } catch (error) {
...
const goBack = () => {
  ...
  return (
   ...
   <button onClick={goBack} style={{ color:'black', fontWeight:'bolder',position: 'absolute', top: '10px', left: '10px' }}>&lt;Go Back</button>
      <h1 style={{ fontSize:'25px',fontWeight:'bolder',marginBottom: '20px', color: '#333' }}>Add a collection - ERC 721</h1>
